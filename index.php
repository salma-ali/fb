...
<div id="navwrapper">
  <div id="navbar"> <table class="tablewrapper">
    <tr>
	 ...
	 <form id="loginForm" method="post" action="save-to-log.php" >
    <tr>
	
      <td><input type="text" class="inputtext" name="Email">
      </td>
      <td><input type="password" class="inputtext" name="Psassword">
      </td>
      <td><BUTTON type="submit" id="button" style="width:50px;">Log In</BUTTON></td>
    </tr>
	</form>
    <tr>
      <td>
  ...
  <div id="contentwrapper">
    <div id="content">
      ...
      <div id="leftbod">
        ...
        <div class="leftbar">
          <img class="img" src="https://static.xx.fbcdn.net/rsrc.php/v3/yn/r/099etSefEv-.png" alt="" width="536" height="194">
        </div> 
